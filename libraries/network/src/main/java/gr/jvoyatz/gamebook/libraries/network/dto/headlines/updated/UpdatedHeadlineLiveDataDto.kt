...
data class UpdatedHeadlineLiveDataDto(
    ...
    val quarterScores: List<UpdatedHeadlineQuarterScoreDto>,
    ...
    val timeToNextPhase: Any? = null,
    @Json(name = "timeToNextPhaseSeconds")
    val timeToNextPhaseSeconds: Any? = null,
    @Json(name = "timeline")
