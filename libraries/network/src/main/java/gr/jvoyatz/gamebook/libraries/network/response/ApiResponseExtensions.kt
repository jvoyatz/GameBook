...
import gr.jvoyatz.gamebook.libraries.network.response.ApiResponse.ApiError
...
import gr.jvoyatz.gamebook.libraries.network.response.ApiResponse.UnexpectedError
